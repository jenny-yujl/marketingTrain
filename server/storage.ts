...
export class MemStorage implements IStorage {
  ...
  async createCampaign(insertCampaign: InsertCampaign): Promise<Campaign> {
    ...
    const campaign: Campaign = {
      ...
      placements: insertCampaign.placements || [],
      deviceTypes: insertCampaign.deviceTypes || [],
      interests: insertCampaign.interests || [],
      behaviors: insertCampaign.behaviors || [],
      weeklySchedule: insertCampaign.weeklySchedule || [],
      createdAt: new Date(),
      updatedAt: new Date(),
    };
  ...
  async updateCampaign(id: number, updateData: Partial<InsertCampaign>): Promise<Campaign> {
    ...
    const updatedCampaign: Campaign = {
      ...
      placements: updateData.placements || existingCampaign.placements || [],
      deviceTypes: updateData.deviceTypes || existingCampaign.deviceTypes || [],
      interests: updateData.interests || existingCampaign.interests || [],
      behaviors: updateData.behaviors || existingCampaign.behaviors || [],
      weeklySchedule: updateData.weeklySchedule || existingCampaign.weeklySchedule || [],
      updatedAt: new Date(),
    };
